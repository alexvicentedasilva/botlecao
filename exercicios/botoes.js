...
let contagem = 0
let link = 'https://t.me/+8qlR-8LmDutkNTIx'

const botoes = Extra.markup(Markup.inlineKeyboard([           //quando vc clicar no botao  o que vai ser passado pro
    Markup.callbackButton('+1', 'add 1'),                     //bot é o segundo parâmetro
    ...
    Markup.callbackButton('link','link')
], { columns: 3 }))
